...
class FourthController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        menu = Menu(frame: CGRect(x: -220, y: 80 ,width: 220 , height: 220),view: 3,items: ["Первый","Второй","Третий","Четвертый"])
        menu.delegate = self
...
extension FourthController : MenuDelegate {
